# SIG示例项目汇总
> 相关项目仅用于学习参考与交流，不能用于任何其它用途。

## XNA

[人类非编码RNA亚细胞定位的挖掘分析与预测研究](https://gitee.com/qlnu/ncrna_subcellular-localization_prediction_mining_human.git)


[拟南芥孤儿基因的识别与功能预测研究](https://gitee.com/qlnu/orphan-gene_prediction_mining_arabidopsis.git)
## Protein

[EGFR基因变异对蛋白质构象及药物设计影响的研究](https://gitee.com/qlnu/egfr_gene-variation_protein-conformation_drug-design.git)
...
[秸秆还田对土壤微生物多样性及网络复杂度的影响研究](https://gitee.com/qlnu/soil-microbiome_straw-returning_microbial-network.git)
