...
> 注：1. 本问卷对于BIers@QLNU不是必选项；
> 2. 所提交的问题尽可能明确，不要只是臆想。
## BI@QLNU专属
> 相应任务完成后，BIers@QLNU必需完成如下调查；
> 已经完成的不用重复提交，除非之前填写的不正确或存在问题。

[邮箱客户端使用情况调查](https://v.wjx.cn/vm/wm8GCuo.aspx# )

[BI_QLNU共享日历订阅调查](https://v.wjx.cn/vm/ryIKLJA.aspx#)
